...
module.exports = function($state, SupportedFormatsModel, SelectionStateModel, AnalyticsService, ErrorService, OSDialogService) {
  ...
  /**
   * @summary Open image selector and then go to the subsequent flashing page
   * @function
   * @public
   *
   * @example
   * ImageSelectionController.openImageSelectorAndGoFlashPage();
   */
  this.openImageSelectorAndGoFlashPage = () => {
    this.openImageSelector().then(() => {
      $state.go('flash');
    });
  };
