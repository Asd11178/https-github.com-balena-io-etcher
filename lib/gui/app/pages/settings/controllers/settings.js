...
module.exports = function (WarningModalService) {
  ...
  /**
   * @summary Show package auto-updater setting based on an env var
   * @function
   * @public
   *
   * @returns {Boolean}
   *
   * @example
   * SettingsController.shouldShowPackageAutoUpdater()
   */
  this.shouldShowPackageAutoUpdater = () => {
    return !settings.get('disablePackageAutoUpdater')
  }
}
