...
const app = angular.module('Etcher', [
  ...
  require('./pages/drives/drives'),
  require('./pages/images/images'),
  require('./pages/flash/flash'),
...
app.config(($urlRouterProvider, $uibTooltipProvider) => {
  $urlRouterProvider.otherwise('/drives');
